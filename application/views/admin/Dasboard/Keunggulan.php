        ...
        <div class="row">
            <div class="col-md-12">
                <div class="x_panel">
                    ...
                    <div class="float-right"><a href="javascript:void(0);" class="btn btn-primary" data-toggle="modal" data-target="#Modal_Add"><span class="fa fa-plus"></span> Add Keunggulan</a></div>
                        <div class="clearfix"></div>
                    </div>
                    <div class="x_content">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title" >APAKAH ANDA YAKIN INGIN MENGHAPUS KRUNGGULAN INI</h4>
            </div>
...
<div class="modal fade docs-cropped" id="Modal_Edit" aria-hidden="true" aria-labelledby="getCroppedCanvasTitle" role="dialog" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">                                              
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title" >SILAHKAN MASUKKAN JUDUL DAN KETERANGAN KEUNGGULAN YANG INGIN BARU</h4>
            </div>
            <form id="submitedit">
            <div class="modal-body">
                
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12">Nama Keunggulan</label>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        function show_layanan(){
		    $.ajax({
		        type  : 'ajax',
		        url   : '<?php echo site_url('Keunggulan_controllers/layanan_data')?>',
		        async : false,
		        dataType : 'json',
        ...
        $('#submit').submit(function(e){
		    ...
		    e.preventDefault();
		        ...
		        $.ajax({
		            url  : "<?php echo site_url('Keunggulan_controllers/save')?>",
		            type:"post",	
        ...
        $('#btn_delete').on('click',function(){
            ...
            $.ajax({
                type : "POST",
                url  : "<?php echo site_url('Keunggulan_controllers/delete')?>",
                dataType : "JSON",
                data : {kd_sps:kd_sps},
                success: function(data){
        ...
        $('#submitedit').submit(function(e){
            e.preventDefault();
		        $.ajax({
		            url  : "<?php echo site_url('Keunggulan_controllers/update')?>",
		            type:"post",	
		            data:new FormData(this), //this is formData
		            processData:false,
		            contentType:false,
