...
<html lang="en">
  <head>
    ...
    <!-- PNotify -->
    <link href="<?php echo base_url('assets/admin/vendors/pnotify/dist/pnotify.css')?>" rel="stylesheet">
    <link href="<?php echo base_url('assets/admin/vendors/pnotify/dist/pnotify.buttons.css')?>" rel="stylesheet">
    <link href="<?php echo base_url('assets/admin/vendors/pnotify/dist/pnotify.nonblock.css')?>" rel="stylesheet">
    <!-- Bootstrap Colorpicker -->
    <link href="<?php echo base_url('assets/admin/vendors/mjolnic-bootstrap-colorpicker/dist/css/bootstrap-colorpicker.min.css')?>" rel="stylesheet">
    <link href="<?php echo base_url('assets/admin/vendors/cropper/dist/cropper.min.css')?>" rel="stylesheet">
    <!-- Custom Theme Style -->
