        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                        <select class="select2_single form-control" name="Mulai" id="Mulai" tabindex="-1" id="">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                        <select class="select2_single form-control" name="Selesai" id="Selesai" tabindex="-1" id="">
                            <option value="00:00:00">00:00:00</option>
                            <option value="01:00:00">01:00:00</option>
                            <option value="02:00:00">02:00:00</option>
                            <option value="03:00:00">03:00:00</option>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12">Jam Mulai</label>
                    <div class="col-md-9 col-sm-9 col-xs-12">
                        <select class="select2_single form-control" name="Mulai_Edit" id="Mulai_Edit" tabindex="-1" id="">
                            <option value="00:00:00">00:00:00</option>
                            <option value="01:00:00">01:00:00</option>
                            <option value="02:00:00">02:00:00</option>
                            <option value="03:00:00">03:00:00</option>
                ...
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12">Jam Selesai</label>
                    <div class="col-md-9 col-sm-9 col-xs-12">
                        <select class="select2_single form-control" name="Selesai_Edit" id="Selesai_Edit" tabindex="-1" id="">
                            <option value="00:00:00">00:00:00</option>
                            <option value="01:00:00">01:00:00</option>
                            <option value="02:00:00">02:00:00</option>
                            <option value="03:00:00">03:00:00</option>
            ...
            <div class="modal-footer">
                <button type="button" type="submit" id="btn_back2" class="btn btn-secondary" data-dismiss="modal">Back</button>
...
<script type="text/javascript">
    $(document).ready(function(){
		        ...
		        success : function(data){
		            ...
		            for(i=0; i<data.length; i++){
		                html += '<tr>'+
                                ...
                                '<td>'+'<a href="javascript:void(0);" class="btn btn-info btn-sm item_edit" data-kd_jadwal="'+data[i].Id+'" data-nm_dokter="'+data[i].nm_dokter+'" data-nm_sps="'+data[i].nm_sps+'" data-mulai="'+data[i].jam_mulai+'" data-selesai="'+data[i].jam_selesai+'" >Edit</a>'+'</td>'+
                                '<td>'+'<a href="javascript:void(0);" class="btn btn-danger btn-sm item_delete" data-kd_jadwal="'+data[i].Id+'" data-dokter="'+data[i].nm_dokter+'">Delete</a>'+'</td>'+
		                        '</tr>';
		            }
		            $('#show_data').html(html);
		        }
        ...
        //UPDATE DELETE SAVE FOR FORM JADWAL DOKTER
        ...
        $('#btn_save').on('click',function(){
            ...
            if(Mulai=="" && Selesai==""){alert("Jam Mulai dan Jam Selesai Tidak Boleh Kosong");}
            if(Mulai!="" && Selesai!=""){
            $.ajax({
                type : "POST",
